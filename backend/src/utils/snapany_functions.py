...
# 测试链接
# TEST_URL = "https://www.youtube.com/shorts/lKVtdaYObag"
TEST_URL = "https://www.bilibili.com/video/BV1Yx4y1Q754"
SNAPANY_API_URL = "https://api.snapany.com/v1/extract"
SNAPANY_WEBSITE_URL = "https://snapany.com/zh/"
            ...
            async def handle_response(response):
                ...
                if response.url == SNAPANY_API_URL and response.status == 200:
                    try:
                        ...
                        logger.info(f"捕获到API响应: {json.dumps(api_response_data, ensure_ascii=False)}")
                    except:
...
async def main():
    result = await extract_url(TEST_URL)
    print(f"结果: {result}")
